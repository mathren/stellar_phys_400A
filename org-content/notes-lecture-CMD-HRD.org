...
We have effectively introduced two types of related diagram:
 - Color-magnitude diagram ~ a "family picture" at a given time of
   many different stars;
 - Theoretical HR diagram ~ a "movie" of the life of one (or possibly
...
star forming region in the LMC that contains ~1000 massive stars. This
