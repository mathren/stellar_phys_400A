...
- Using =MESA-web=, which contains tabulated data for nuclear reactions
  ...
  *N.B.:* Computing the evolution of massive stars through /all/ the
  ...
  I have tried the default settings except a 15M_{\odot} initial mass and
  got to an oxygen-rich composition in the core (so not till the very end,
  feel free to explore different combinations!):
