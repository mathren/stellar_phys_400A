...
#+begin_latex
\begin{equation}
\tau_\mathrm{nuc} = \varphi f_{burn} \frac{Mc^{2}}{L_{nuc}} \equiv \varphi f_{burn} \frac{Mc^{2}}{L_{}} \ \ ,
\end{equation}
#+end_latex
...
\tau_\mathrm{nuc} \simeq 10^{10} \frac{f_{burn}_{}}{0.1} \frac{M}{M_{\odot}} \frac{L}{L_{\odot}} \ \mathrm{yr} \ \ .
\end{equation}
#+end_latex
...
#+begin_latex
\begin{equation}\label{eq:tau_nuc_scaling}
B = (Zm_{p}+(A-Z)m_{n} - m_{nucleus})c^{2} \simeq (Zm_{H}+(A-Z)m_{n} - m_{nucleus})c^{2} + \mathcal{O}(10\mathrm{eV})>0 \ \ ,
\end{equation}
#+end_latex
