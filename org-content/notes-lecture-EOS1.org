...
From this, we can calculate the pressure of this gas.


By definition
this will be isotropic, and so we
can imagine to put a "box" through
our gas (the orientation of the
walls does not matter), and to
determine the gas pressure we want
the force exerted by the gas per
unit area of the walls. By Newton's
...
#+begin_latex
\begin{equation}
\Delta p = 2 p cos(\theta) \mathrm{with}
