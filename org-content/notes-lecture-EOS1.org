...
and be in thermal equilibrium!), but such as that the energy \varepsilon
exchanged in the particle-particle interactions is much small than
their kinetic energy (due to their thermal motion).

The equipartition theorem says that for such a gas of
