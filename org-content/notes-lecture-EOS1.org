...
Maxwell-Boltzmann (for particles) and the black-body spectrum (for
...
#+begin_latex
\begin{equation}
\Delta T \simeq \lambda_{\gamma} dT/dr \le \lambda_{\gamma} T_\mathrm{center}/R
\end{equation}
#+end_latex
...
for the average T and \rho of the Sun. We also see that at progressively
lower temperature the Coulomb interaction start to matter (this is
important for the crystallization of WDs for instance), or at
increasingly high densities.
