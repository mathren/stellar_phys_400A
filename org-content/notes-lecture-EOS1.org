...
#+begin_latex
\begin{equation}
\frac{1}{\mu} = \frac{1}{\mu_\mathrm{ion}_{}}+\frac{1}{\mu_{e}} \ \ ,
\end{equation}
#+end_latex
...
mixture of gases (assumed to be in LTE) as a single gas! *N.B.:* this
holds as long as every species satisfies our assumption of ideal,
non-relativistic, classical gas.
