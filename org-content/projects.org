...
#+ATTR_LATEX: :font \tiny :float sideways
  ...
  |                               | way. The physics presented is sound and           | physics is clearly explained and the       | appropriate way that the reader can follow.  | implicit and not enough pointers    |
