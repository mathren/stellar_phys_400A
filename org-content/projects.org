...
in class, and at the same we can all learn from each other!
...
6. Astrometric detection of /Gaia/ BH1, BH2, BH3, and NS1
7. Tides in stars
8. Algol Paradox
9. Common envelope evolution
10. Roche model and mass transfer
11. Globular clusters: CMD
12. Globular clusters: dynamics
13. Formation of stars
14. Stars in galaxies: Chemical evolution
15. Stars in galaxies: Mechanical feedback
16. Stars in galaxies: Radiative feedback
17. Nucleosynthesis: s-process
18. Nucleosynthesis: r-process
19. X-ray binaries
20. Thermonuclear explosion in WDs
21. Neutron star structure
22. The Eddington limit
23. Convective boundary mixing
24. Nuclear reaction chains
25. Stellar winds: Parker model and its updates
26. Stellar winds: radiatively driven
27. Analytic stellar models: Lane-Emden equation
28. Analytic stellar models: Eddington standard model
29. Novae
30. Supermassive stars
31. Stellar neutrinos
32. Pair instability supernovae
33. Triple systems: Kozai-Lidov-von Zeipel oscillations
34. Formation of gravitational wave progenitors: isolated binary evolution
35. Formation of gravitational wave progenitors: dynamical channels
36. Orbital architectures of (star+star) binaries in the Universe

** Recommended sources
You are free to do your own research, but in the final manuscript (and
when appropriate in the oral presentation) you need to cite the
relevant sources. These can be textbooks, review papers, and/or
journal articles. To find journal articles, you can use [[https://ui.adsabs.harvard.edu/][NASA/ADS]]. You
can use online freely-available resources (e.g., Wikipedia) as a
starting point, but should go find /primary/ sources (e.g., what
Wikipedia itself cites, if not the references cited by the source from
Wikipedia, and so on down...).
