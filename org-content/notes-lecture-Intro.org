...
This will be the first complete course that I teach. However, this is
on stellar evolution, which is the research topic I work on. More
specifically, I work on the evolution of massive stars in binary
systems. These are the stars that end their lifes in /supernova
...
this is /not/ that important in the end: even if the father up you climb
...
may be. We will do this though a project, that we will discuss later.
