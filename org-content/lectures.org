...
*Aim*: Introduce pp chain, CN-NO bi-cycle, 3\alpha burning. Introduce general
principles of stellar evolution codes, =MESA-web=, and =MESA=.

[[./notes-lecture-nuclear-cycles.org][Notes on nuclear reaction chains]]

** <2024-10-08 Tue> - Neutrino cooling + introduction to stellar evolution codes
*Aim*: discuss neutrino cooling processes, complete the physics needed
for 1D stellar evolution calculation, introduce general principles of
