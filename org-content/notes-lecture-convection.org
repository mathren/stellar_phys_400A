...
#+begin_latex
\begin{equation}
\Delta\rho \simeq \left(\rho_{1} +\frac{d\rho}{dr}_\mathrm{ad} \ell\right) - \left(\rho_{1} +\frac{d\rho}{dr}_\mathrm{rad} \ell\right) \ \ ,
\end{equation}
#+end_latex
...
this to estimate the work done by buoyancy.
