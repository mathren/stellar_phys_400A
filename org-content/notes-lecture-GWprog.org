...
Today, we know of $\sim100$ BBH mergers, a couple of BNS merger, and we
have a few BH-NS mergers (but unfortunately all BNS except GW170817
and all BH-NS mergers have been too far for the detection of EM
counterparts): we already know more stellar-mass BH from GWs than any
other EM signature!
...
(GW170817 confirmed that BNS mergers are one site for r-process
...
#+CAPTION: Sensitivity curves of present and planned GW detectors: Ground based detectors are on the right (highest frequencies), space-based in the middle, and galaxy-size pulsar-timing based on the left. From [[https://ui.adsabs.harvard.edu/abs/2015CQGra..32a5014M/abstract][Moore et al. 2015]]
#+ATTR_HTML: :width 100%
