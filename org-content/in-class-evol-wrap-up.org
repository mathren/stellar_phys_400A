...
#+CAPTION: Example of an /HST/ image of a planetary nebula: NGC6543 (aka Cat's eye nebula). A catalog of planetary nebulae images is available [[https://faculty.washington.edu/balick/PNIC/][here]].
#+ATTR_HTML: :width 100%
[[./images/catseye.jpg]]
...
the electron degeneracy pressure: the degeneracy decoupled their
structure (which can be approximated assuming $k_{B}T\ll \varepsilon_{Fermi}
