...
since m_{e} \ll m_{ion} (in fact m_{e} \simeq m_{proton}/1836.15 \simeq
...
** Fully degenerate electron gas
  ...
  made, e.g., [[https://ui.adsabs.harvard.edu/abs/2020MNRAS.497.4357C/abstract][Caplan 2020]]). What we really mean by taking the T\rightarrow0
...
its electron from the fundamental state), that is 1eV/k_{B} ~ 10^{4} K, and
