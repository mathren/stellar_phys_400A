...
#+begin_latex
\begin{equation}
S = J = \frac{3 P c}{4\pi} = \frac{3F\tau}{4\pi} + \mathrm{constant} \ \ ,
\end{equation}
#+end_latex
...
#+begin_latex
\begin{equation}
F = 2\pi\int_{0}^{1}T\cos(\theta)d\cos(\theta) = \frac{3F}{2}\int_{0}^{1}\left(\cos^{2}(\theta)+\mathrm{constant}\cos(theta)\right)d\cos(\theta) = \frac{3F}{4\pi}(\cos(\theta)+\mathrm{constant}) \Rightarrow \mathrm{constant} = \frac{2}{3} \ \ .
\end{equation}
#+end_latex
