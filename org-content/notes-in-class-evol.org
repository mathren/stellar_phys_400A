...
5. what is the /structure/ of the star during H core burning (core vs.
   envelope). and why?
6. can you explain the morphology of the end of the H-core burning
   main sequence?
7. where does He core burning start?
8. is there any other nuclear burning during He core burning? And before?
