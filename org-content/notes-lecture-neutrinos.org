...
layer: /evolved massive stars are neutrino stars/ ([[https://ui.adsabs.harvard.edu/abs/1968Ap%26SS...2...96F/abstract][Fraley 1968]]), L_{\nu}
\gg L_{rad}.
...
#+CAPTION: Neutrino energy losses on the T(\rho) plane. White lines mark the separation between regions where different neutrino emission processes dominate, the colored lines mark the T(\rho) tracks of helium cores of the labeled masses computed with MESA. Credits: R. Farmer.
#+ATTR_HTML: :width 100%
