...
wealthy computer-scientist turned astronomer, [[https://en.wikipedia.org/wiki/Bill_Paxton_(computer_scientist)][Bill Paxton]], with the
collaboration of a large group of theoretical and computational
astrophysicists, developed a new open-source, multi-purpose, and
community driven stellar structure and evolution code, called =MESA=.
The =MESA-web= interface you have been using is just a predefined setup
of this very flexible and modular code designed for educational
applications: you have been using a bleeding edge research tools!
