...
have been designing and leveraging /computational techniques/
to /numerically/ solve this system of equations.
...
/experiment stumble, simulations may offer a third way./"
Simulation, Johannes Lenhard et al.
:end:

Moreover, the /high non-linearity/ of the system means that there can be
