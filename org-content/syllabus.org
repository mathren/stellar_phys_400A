...
By the end of the course, students will be able to:
 ...
 - *Distinguish and assess observationally confirmed elements of stellar physics from numerical results.*
...
=MESA-web= interface simplifies the access to this state-of-the-art tool.
