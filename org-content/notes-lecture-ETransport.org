...
the specific heat at constant volume of the gas, considered constant,
because the energy carried by particle diffusion in the gas is a heat
source at constant volume.
