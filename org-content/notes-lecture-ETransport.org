...
physics for the star. We will [[https://www.as.arizona.edu/~mrenzo/materials/nuclear_reaction_rates.pdf][later]] unpack more \varepsilon_\mathrm{nuc} by discussing
...
while unpacking \varepsilon_\mathrm{nuc} we will write a set of equations for the chemical
