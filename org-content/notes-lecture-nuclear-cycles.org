...
$L_\mathrm{nuc} \equiv L$ making the nuclear burning a [[./notes-lecture-nuclear-burning.org::*Energy generation as a self-regulating process][self-regulating
process]] where it is $L$ (the energy loss rate) that determines
