...
involved in thermonuclear burnings. For a generic charged particle
thermonuclear reaction X(a,b)Y we can write:
#+begin_latex
\begin{equation}
...
Therefore, because of the multiplication between the tunneling
probability and the Maxwell-Boltzmann distribution producing the
"Gamow peak" and nuclear resonances, thermonuclear reaction rates are
strongly peaked functions of the temperature.
